 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MarkedRenderer extends marked__WEBPACK_IMPORTED_MODULE_4__["Renderer"] {
}
...
class MarkdownService {
    ...
    compile(markdown, decodeHtml = false, markedOptions = this.options) {
        ...
        /** @type {?} */
        const compiled = Object(marked__WEBPACK_IMPORTED_MODULE_4__["parse"])(precompiled, markedOptions);
...
let ArticleService = class ArticleService {
    ...
    getArticleByFileName(fileName) {
        let fullpath = this.getFullPathOfArticleList();
        return this.httpclient.get(fullpath).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(articles => articles.filter(article => article.fileName === fileName)[0]));
    }
    getArticleContent(fileName, category) {
        let fullPath = this.getFullPathOfArticle(fileName, category);
        return this.httpclient.get(fullPath, { responseType: 'text' });
    }
    getFullPathOfArticleList() {
        let blogContentUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].blog_content_url;
        return blogContentUrl + "/" + "articles/articles.json";
    }
    getFullPathOfArticle(name, category) {
        let blogContentUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].blog_content_url;
...
//# sourceMappingURL=default~article-article-module~home-home-module-es2015.js.map